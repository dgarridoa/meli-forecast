...
from meli_forecast.model import DistributedModel
        ...
        pd.DataFrame(
            {
                ...
                "date": [date(2024, 7, 4) + timedelta(i) for i in range(35)],
                "sales": [
                    2522.0,
                    2403.0,
                    2689.0,
        ...
        pd.DataFrame(
            {
                ...
                "city": "B1",
                "product_id": "8fa69e11-c148-470d-a4f1-1a1781079435",
                "date": [date(2024, 8, 1) + timedelta(i) for i in range(7)],
        ...
        pd.DataFrame(
            {
                ...
                "city": "B1",
                "product_id": "8fa69e11-c148-470d-a4f1-1a1781079435",
                "date": [date(2024, 8, 8) + timedelta(i) for i in range(2)],
