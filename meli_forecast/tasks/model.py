...
from meli_forecast.model import DistributedModel, ModelProtocol
from meli_forecast.params import ModelParams, Params, read_config
...
class ModelTask:
    ...
    def read(self, spark: SparkSession) -> DataFrame:
        df = read_table(spark, self.params.database, "split")
        return df
